...
//        db = gdbf.newImpermanentDatabaseBuilder()( "/Users/peterneubauer/code/tmp/db-" + System.currentTimeMillis()).newGraphDatabase();
        db = gdbf.newImpermanentDatabaseBuilder().newGraphDatabase();
